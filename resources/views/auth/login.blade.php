...
<body>
    <section class="background">
        <form class="container" action="{{ route('login-post') }}" method="post">
            @csrf
            <div class="container-title">
                <h1>Masuk</h1>
                <p>Masukkan Nama dan Kata Sandi Anda Dengan Benar</p>
            </div>
            ...
            <button>Masuk</button>
            <p class="ask">Belum punya Akun? <a href="/register">Daftar</a></p>
        </form>
    </section>
